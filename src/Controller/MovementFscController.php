...
class MovementFscController extends AbstractController
{
    ...
    public function __construct(fscListMovementRepository $fscAttachedFileRepo, ControleArticlesFscRepository $controleArticleFscRepo, MouvRepository $mouvRepo, CommentairesRepository $commentairesRepo)
    {
