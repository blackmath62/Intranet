...
class StatesParFamilleController extends AbstractController
{
    ...
    public function commerciaux($dos, $dd = null, $df = null, Request $request, StatesByTiersRepository $repo, ResumeStatesController $resume): Response
    {
        ...
        // initialisation de mes variables
        if ($request->attributes->get('_route') == 'app_states_commerciaux' | $request->attributes->get('_route') == 'app_states_commerciauxLh' | $request->attributes->get('_route') == 'app_states_commerciaux_dd_df' | $request->attributes->get('_route') == 'app_states_commerciaux_dd_dfLh') {
            $famille = "produits";
        } elseif ($request->attributes->get('_route') == 'app_states_commerciaux_clients' | $request->attributes->get('_route') == 'app_states_commerciaux_clients_dd_df' | $request->attributes->get('_route') == 'app_states_commerciaux_clientsLh' | $request->attributes->get('_route') == 'app_states_commerciaux_clients_dd_dfLh') {
            $famille = "clients";
        }
        ...
        $caSixAnnees = $repo->getStatesSevenYearsAgo($dos, 'annee');
