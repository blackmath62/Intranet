...
class SignatureElectroniqueController extends AbstractController
{
    ...
    function show(SignatureElectronique $signatureElectronique): Response
    {
    ...
    function edit(Request $request, SignatureElectronique $signatureElectronique, SignatureElectroniqueRepository $signatureElectroniqueRepository): Response
    {
        $form = $this->createForm(SignatureElectroniqueType::class, $signatureElectronique);
        $form->handleRequest($request);
    ...
    function delete(Request $request, SignatureElectronique $signatureElectronique, SignatureElectroniqueRepository $signatureElectroniqueRepository): Response
    {
